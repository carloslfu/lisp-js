...
exports.exp = api => exp => {
    ...
    else if (tokenizer_1.stringDelimiters.indexOf(exp[0]) !== -1
        && tokenizer_1.stringDelimiters.indexOf(exp[exp.length - 1]) !== -1) {
...
exports.evalAst = api => ast => {
    ...
    else if (exports.atoms[op]) {
        return exports.atoms[op](api, args);
    }
    else {
...
exports.evaluateFn = evaluateFn;
exports.setValue = (api, stack) => (name, value) => {
    let scope = stack[stack.length - 1];
    scope[name] = value;
};
exports.getValue = (api, stack) => name => {
...
exports.makeAPI = env => {
    let stack = [];
    let api = {
        env: Object.assign({}, exports.constants, env),
        _pushScope: () => stack.push({}),
        _popScope: () => stack.pop(),
    };
    api.evalAst = exports.evalAst(api);
    api.exp = exports.exp(api);
    api.getValue = exports.getValue(api, stack);
    api.setValue = exports.setValue(api, stack);
    return api;
};
exports.constants = {
    'true': ['atom', true],
